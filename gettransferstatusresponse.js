...
goog.provide('proto.cs3.tx.v1beta1.GetTransferStatusResponse');
...
proto.cs3.tx.v1beta1.GetTransferStatusResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    txInfo: (f = msg.getTxInfo()) && proto.cs3.tx.v1beta1.TxInfo.toObject(includeInstance, f),
...
proto.cs3.tx.v1beta1.GetTransferStatusResponse.prototype.getTxInfo = function() {
  return /** @type{?proto.cs3.tx.v1beta1.TxInfo} */ (
    jspb.Message.getWrapperField(this, proto.cs3.tx.v1beta1.TxInfo, 2));
};
