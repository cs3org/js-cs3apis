...
goog.provide('proto.cs3.storage.provider.v1beta1.MoveRequest');
...
proto.cs3.storage.provider.v1beta1.MoveRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    source: (f = msg.getSource()) && proto.cs3.storage.provider.v1beta1.Reference.toObject(includeInstance, f),
    destination: (f = msg.getDestination()) && proto.cs3.storage.provider.v1beta1.Reference.toObject(includeInstance, f),
