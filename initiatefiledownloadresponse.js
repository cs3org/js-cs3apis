...
goog.provide('proto.cs3.gateway.v1beta1.InitiateFileDownloadResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cs3.gateway.v1beta1.FileDownloadProtocol');
...
proto.cs3.gateway.v1beta1.InitiateFileDownloadResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.cs3.gateway.v1beta1.FileDownloadProtocol.toObject, includeInstance)
  };
...
proto.cs3.gateway.v1beta1.InitiateFileDownloadResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.cs3.gateway.v1beta1.FileDownloadProtocol;
      reader.readMessage(value,proto.cs3.gateway.v1beta1.FileDownloadProtocol.deserializeBinaryFromReader);
...
proto.cs3.gateway.v1beta1.InitiateFileDownloadResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.cs3.gateway.v1beta1.FileDownloadProtocol.serializeBinaryToWriter
    );
  }
};
...
proto.cs3.gateway.v1beta1.InitiateFileDownloadResponse.prototype.getProtocolsList = function() {
  return /** @type{!Array<!proto.cs3.gateway.v1beta1.FileDownloadProtocol>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.cs3.gateway.v1beta1.FileDownloadProtocol, 3));
};
