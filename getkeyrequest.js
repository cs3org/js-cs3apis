...
goog.provide('proto.cs3.preferences.v1beta1.GetKeyRequest');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cs3.preferences.v1beta1.PreferenceKey');
...
proto.cs3.preferences.v1beta1.GetKeyRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    key: (f = msg.getKey()) && proto.cs3.preferences.v1beta1.PreferenceKey.toObject(includeInstance, f)
  };
...
proto.cs3.preferences.v1beta1.GetKeyRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cs3.preferences.v1beta1.PreferenceKey;
      reader.readMessage(value,proto.cs3.preferences.v1beta1.PreferenceKey.deserializeBinaryFromReader);
      msg.setKey(value);
      break;
    default:
      reader.skipField();
...
proto.cs3.preferences.v1beta1.GetKeyRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.cs3.preferences.v1beta1.PreferenceKey.serializeBinaryToWriter
    );
  }
};
...
proto.cs3.preferences.v1beta1.GetKeyRequest.prototype.getKey = function() {
  return /** @type{?proto.cs3.preferences.v1beta1.PreferenceKey} */ (
    jspb.Message.getWrapperField(this, proto.cs3.preferences.v1beta1.PreferenceKey, 1));
};
