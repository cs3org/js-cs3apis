...
goog.provide('proto.cs3.storage.provider.v1beta1.InitiateFileUploadResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cs3.rpc.v1beta1.Status');
goog.require('proto.cs3.storage.provider.v1beta1.FileUploadProtocol');
...
proto.cs3.storage.provider.v1beta1.InitiateFileUploadResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.cs3.storage.provider.v1beta1.FileUploadProtocol.toObject, includeInstance)
  };
...
proto.cs3.storage.provider.v1beta1.InitiateFileUploadResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.cs3.storage.provider.v1beta1.FileUploadProtocol;
      reader.readMessage(value,proto.cs3.storage.provider.v1beta1.FileUploadProtocol.deserializeBinaryFromReader);
...
proto.cs3.storage.provider.v1beta1.InitiateFileUploadResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.cs3.storage.provider.v1beta1.FileUploadProtocol.serializeBinaryToWriter
    );
  }
};
...
proto.cs3.storage.provider.v1beta1.InitiateFileUploadResponse.prototype.getProtocolsList = function() {
  return /** @type{!Array<!proto.cs3.storage.provider.v1beta1.FileUploadProtocol>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.cs3.storage.provider.v1beta1.FileUploadProtocol, 3));
};
