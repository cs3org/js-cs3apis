...
goog.provide('proto.cs3.storage.provider.v1beta1.ListFileVersionsResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cs3.rpc.v1beta1.Status');
goog.require('proto.cs3.storage.provider.v1beta1.FileVersion');
...
proto.cs3.storage.provider.v1beta1.ListFileVersionsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.cs3.storage.provider.v1beta1.FileVersion.toObject, includeInstance),
...
proto.cs3.storage.provider.v1beta1.ListFileVersionsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.cs3.storage.provider.v1beta1.FileVersion;
      reader.readMessage(value,proto.cs3.storage.provider.v1beta1.FileVersion.deserializeBinaryFromReader);
...
proto.cs3.storage.provider.v1beta1.ListFileVersionsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.cs3.storage.provider.v1beta1.FileVersion.serializeBinaryToWriter
    );
  }
...
proto.cs3.storage.provider.v1beta1.ListFileVersionsResponse.prototype.getVersionsList = function() {
  return /** @type{!Array<!proto.cs3.storage.provider.v1beta1.FileVersion>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.cs3.storage.provider.v1beta1.FileVersion, 3));
};
