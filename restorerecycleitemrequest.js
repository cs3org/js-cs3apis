...
goog.provide('proto.cs3.storage.provider.v1beta1.RestoreRecycleItemRequest');
...
proto.cs3.storage.provider.v1beta1.RestoreRecycleItemRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    restoreRef: (f = msg.getRestoreRef()) && proto.cs3.storage.provider.v1beta1.Reference.toObject(includeInstance, f),
