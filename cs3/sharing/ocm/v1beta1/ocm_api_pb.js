...
goog.exportSymbol('proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest', null, global);
goog.exportSymbol('proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenResponse', null, global);
 ...
 * @constructor
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.displayName = 'proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.cs3.sharing.ocm.v1beta1.UpdateOCMShareRequest.UpdateField.prototype.setExpiration = function(value) {
  jspb.Message.setOneofWrapperField(this, 1, proto.cs3.sharing.ocm.v1beta1.UpdateOCMShareRequest.UpdateField.oneofGroups_[0], value);
};
...
proto.cs3.sharing.ocm.v1beta1.UpdateOCMShareRequest.UpdateField.prototype.clearAccessMethods = function() {
  this.setAccessMethods(undefined);
};
 ...
 * @return {!Object}
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest}
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest;
  return proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest}
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getToken();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenRequest.prototype.setToken = function(value) {
...
proto.cs3.sharing.ocm.v1beta1.GetOCMShareByTokenResponse.prototype.getShare = function() {
  return /** @type{?proto.cs3.sharing.ocm.v1beta1.Share} */ (
    jspb.Message.getWrapperField(this, cs3_sharing_ocm_v1beta1_resources_pb.Share, 2));
};
 ...
 * @return {?proto.cs3.sharing.ocm.v1beta1.ReceivedShare}
 */
proto.cs3.sharing.ocm.v1beta1.UpdateReceivedOCMShareRequest.prototype.getShare = function() {
  return /** @type{?proto.cs3.sharing.ocm.v1beta1.ReceivedShare} */ (
    jspb.Message.getWrapperField(this, cs3_sharing_ocm_v1beta1_resources_pb.ReceivedShare, 2));
};
 ...
 * @return {boolean}
 */
proto.cs3.sharing.ocm.v1beta1.UpdateReceivedOCMShareRequest.prototype.hasShare = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 */
proto.cs3.sharing.ocm.v1beta1.UpdateReceivedOCMShareRequest.prototype.getUpdateMask = function() {
 ...
 * @return {boolean}
 */
proto.cs3.sharing.ocm.v1beta1.UpdateReceivedOCMShareRequest.prototype.hasUpdateMask = function() {
  return jspb.Message.getField(this, 3) != null;
};
