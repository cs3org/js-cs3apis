...
goog.provide('proto.cs3.auth.provider.v1beta1.ProviderAPIClient');
goog.provide('proto.cs3.auth.provider.v1beta1.ProviderAPIPromiseClient');
...
goog.require('proto.cs3.auth.provider.v1beta1.AuthenticateRequest');
goog.require('proto.cs3.auth.provider.v1beta1.AuthenticateResponse');
 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.cs3.auth.provider.v1beta1.AuthenticateResponse)}
