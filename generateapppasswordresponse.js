...
goog.provide('proto.cs3.auth.applications.v1beta1.GenerateAppPasswordResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cs3.auth.applications.v1beta1.AppPassword');
...
proto.cs3.auth.applications.v1beta1.GenerateAppPasswordResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    appPassword: (f = msg.getAppPassword()) && proto.cs3.auth.applications.v1beta1.AppPassword.toObject(includeInstance, f)
  };
...
proto.cs3.auth.applications.v1beta1.GenerateAppPasswordResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.cs3.auth.applications.v1beta1.AppPassword;
      reader.readMessage(value,proto.cs3.auth.applications.v1beta1.AppPassword.deserializeBinaryFromReader);
...
proto.cs3.auth.applications.v1beta1.GenerateAppPasswordResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.cs3.auth.applications.v1beta1.AppPassword.serializeBinaryToWriter
    );
  }
};
...
proto.cs3.auth.applications.v1beta1.GenerateAppPasswordResponse.prototype.getAppPassword = function() {
  return /** @type{?proto.cs3.auth.applications.v1beta1.AppPassword} */ (
    jspb.Message.getWrapperField(this, proto.cs3.auth.applications.v1beta1.AppPassword, 3));
};
