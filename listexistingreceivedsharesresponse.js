...
goog.require('proto.cs3.gateway.v1beta1.SharedResourceInfo');
...
proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.cs3.gateway.v1beta1.SharedResourceInfo.toObject, includeInstance),
...
proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.cs3.gateway.v1beta1.SharedResourceInfo;
      reader.readMessage(value,proto.cs3.gateway.v1beta1.SharedResourceInfo.deserializeBinaryFromReader);
      msg.addShares(value);
      break;
    case 4:
...
proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.cs3.gateway.v1beta1.SharedResourceInfo.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.cs3.gateway.v1beta1.SharedResourceInfo>}
 */
proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse.prototype.getSharesList = function() {
  return /** @type{!Array<!proto.cs3.gateway.v1beta1.SharedResourceInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.cs3.gateway.v1beta1.SharedResourceInfo, 3));
};


/**
 * @param {!Array<!proto.cs3.gateway.v1beta1.SharedResourceInfo>} value
 * @return {!proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse} returns this
*/
proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse.prototype.setSharesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};


/**
 * @param {!proto.cs3.gateway.v1beta1.SharedResourceInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.cs3.gateway.v1beta1.SharedResourceInfo}
 */
proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse.prototype.addShares = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.cs3.gateway.v1beta1.SharedResourceInfo, opt_index);
};
 ...
 * @return {!proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse} returns this
 */
proto.cs3.gateway.v1beta1.ListExistingReceivedSharesResponse.prototype.clearSharesList = function() {
