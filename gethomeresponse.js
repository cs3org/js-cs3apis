...
goog.provide('proto.cs3.storage.registry.v1beta1.GetHomeResponse');
...
proto.cs3.storage.registry.v1beta1.GetHomeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    provider: (f = msg.getProvider()) && proto.cs3.storage.registry.v1beta1.ProviderInfo.toObject(includeInstance, f)
  };
...
proto.cs3.storage.registry.v1beta1.GetHomeResponse.prototype.getProvider = function() {
  return /** @type{?proto.cs3.storage.registry.v1beta1.ProviderInfo} */ (
    jspb.Message.getWrapperField(this, proto.cs3.storage.registry.v1beta1.ProviderInfo, 3));
};
