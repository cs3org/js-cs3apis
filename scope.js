...
goog.provide('proto.cs3.auth.provider.v1beta1.Scope');
...
goog.forwardDeclare('proto.cs3.auth.provider.v1beta1.Role');
/**
...
proto.cs3.auth.provider.v1beta1.Scope.toObject = function(includeInstance, msg) {
  var f, obj = {
    resource: (f = msg.getResource()) && proto.cs3.types.v1beta1.OpaqueEntry.toObject(includeInstance, f),
...
proto.cs3.auth.provider.v1beta1.Scope.prototype.getResource = function() {
  return /** @type{?proto.cs3.types.v1beta1.OpaqueEntry} */ (
    jspb.Message.getWrapperField(this, proto.cs3.types.v1beta1.OpaqueEntry, 1));
};
