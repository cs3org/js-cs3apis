...
goog.provide('proto.cs3.storage.provider.v1beta1.ListRecycleStreamResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cs3.rpc.v1beta1.Status');
goog.require('proto.cs3.storage.provider.v1beta1.RecycleItem');
...
proto.cs3.storage.provider.v1beta1.ListRecycleStreamResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    recycleItem: (f = msg.getRecycleItem()) && proto.cs3.storage.provider.v1beta1.RecycleItem.toObject(includeInstance, f),
...
proto.cs3.storage.provider.v1beta1.ListRecycleStreamResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.cs3.storage.provider.v1beta1.RecycleItem;
      reader.readMessage(value,proto.cs3.storage.provider.v1beta1.RecycleItem.deserializeBinaryFromReader);
...
proto.cs3.storage.provider.v1beta1.ListRecycleStreamResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.cs3.storage.provider.v1beta1.RecycleItem.serializeBinaryToWriter
    );
  }
...
proto.cs3.storage.provider.v1beta1.ListRecycleStreamResponse.prototype.getRecycleItem = function() {
  return /** @type{?proto.cs3.storage.provider.v1beta1.RecycleItem} */ (
    jspb.Message.getWrapperField(this, proto.cs3.storage.provider.v1beta1.RecycleItem, 3));
};
