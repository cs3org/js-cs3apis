...
goog.provide('proto.cs3.storage.provider.v1beta1.RecycleItem');
...
proto.cs3.storage.provider.v1beta1.RecycleItem.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    deletionTime: (f = msg.getDeletionTime()) && proto.cs3.types.v1beta1.Timestamp.toObject(includeInstance, f)
  };
